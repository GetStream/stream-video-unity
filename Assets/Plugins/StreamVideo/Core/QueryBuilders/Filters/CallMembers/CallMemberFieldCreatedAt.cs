...
{
    /// <summary>
    /// Filter by <see cref="CallMember.CreatedAt"/>
    /// </summary>
    public sealed class CallMemberFieldCreatedAt : BaseFieldToFilter
    {
        public override string FieldName => "created_at";

        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.CreatedAt"/> is EQUAL to ANY of provided user Id
        /// </summary>
