...
namespace StreamVideo.Core.InternalDTO.Events
{
    ...
    internal partial class CallMissedEventInternalDTO
    {
        /// <summary>
        /// Call object
        /// </summary>
        ...
        [Newtonsoft.Json.JsonProperty("notify_user", Required = Newtonsoft.Json.Required.Default)]
        ...
        public string Type { get; set; } = "call.missed";

        /// <summary>
        /// The caller from whom the call was missed
        /// </summary>
