...
namespace StreamVideo.Core.InternalDTO.Events
{
    ...
    internal partial class CallRecordingReadyEventInternalDTO
    {
        [Newtonsoft.Json.JsonProperty("call_cid", Required = Newtonsoft.Json.Required.Default)]
        public string CallCid { get; set; } = default!;

        /// <summary>
        /// The call recording object
        /// </summary>
        [Newtonsoft.Json.JsonProperty("call_recording", Required = Newtonsoft.Json.Required.Default)]
        public CallRecordingInternalDTO CallRecording { get; set; } = new CallRecordingInternalDTO();
        ...
        public string Type { get; set; } = "call.recording_ready";
