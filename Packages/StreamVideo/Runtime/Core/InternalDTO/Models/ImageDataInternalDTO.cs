...
namespace StreamVideo.Core.InternalDTO.Models
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("frames", Required = Newtonsoft.Json.Required.Default)]
        public string Frames { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("height", Required = Newtonsoft.Json.Required.Default)]
        public string Height { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("size", Required = Newtonsoft.Json.Required.Default)]
