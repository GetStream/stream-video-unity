...
namespace StreamVideo.Core.InternalDTO.Responses
{
    ...
    internal partial class JoinCallResponseInternalDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("credentials", Required = Newtonsoft.Json.Required.Default)]
        ...
        [Newtonsoft.Json.JsonProperty("stats_options", Required = Newtonsoft.Json.Required.Default)]
        public StatsOptionsInternalDTO StatsOptions { get; set; } = new StatsOptionsInternalDTO();
