...
namespace StreamVideo.Core.InternalDTO.Responses
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("edge_name", Required = Newtonsoft.Json.Required.Default)]
        public string EdgeName { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("url", Required = Newtonsoft.Json.Required.Default)]
        public string Url { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("ws_endpoint", Required = Newtonsoft.Json.Required.Default)]
