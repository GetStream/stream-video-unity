...
{
    /// <summary>
    /// Filter by <see cref="CallMember.UpdatedAt"/>
    /// </summary>
    public sealed class CallMemberFieldUpdatedAt : BaseFieldToFilter
    {
        public override string FieldName => "update_at";

        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is EQUAL to ANY of provided DateTime values
        /// </summary>
        public FieldFilterRule In(params DateTime[] updatedAt) => InternalIn(updatedAt);
        
        /// <summary>
        /// Return only members where <see cref="CallMember.UpdatedAt"/> is EQUAL to ANY of provided DateTimeOffset values
        /// </summary>
