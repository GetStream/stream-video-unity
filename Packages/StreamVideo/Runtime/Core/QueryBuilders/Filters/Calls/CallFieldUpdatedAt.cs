...
{
    /// <summary>
    /// Filter by <see cref="IStreamCall.UpdatedAt"/>
    /// </summary>
    public sealed class CallFieldUpdatedAt : BaseFieldToFilter
    {
        public override string FieldName => "update_at";

        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is EQUAL to ANY of provided DateTime values
        /// </summary>
        public FieldFilterRule In(params DateTime[] updatedAt) => InternalIn(updatedAt);
        
        /// <summary>
        /// Return only calls where <see cref="IStreamCall.UpdatedAt"/> is EQUAL to ANY of provided DateTimeOffset values
        /// </summary>
