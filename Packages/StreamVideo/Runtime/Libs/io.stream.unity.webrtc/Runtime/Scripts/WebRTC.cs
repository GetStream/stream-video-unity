...
namespace Unity.WebRTC
{
    ...
    public static class WebRTC
    {
        ...
        public static void StartAudioPlayback(int sampleRate, int numChannels)
        {
            Context.StartAudioPlayback(sampleRate, numChannels);
        }
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport(WebRTC.Lib)]
        public static extern void StartAudioPlayback(IntPtr context, int sampleRate, int numChannels);
