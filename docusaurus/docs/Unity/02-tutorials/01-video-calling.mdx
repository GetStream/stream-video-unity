...
### Step 10 - Setup UI view for each participant
...
This means that Unity is not able to access the selected camera or microphone devices. In such case, you need to ensure that no other application is using the devices and try again.
