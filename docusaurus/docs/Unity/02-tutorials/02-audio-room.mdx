...
### Step 8 - Handle call participants
...
### Step 9 - Setup UI view for a call participant
...
### Step 10 - Add UI logic to handle call participants
...
```
This will subscribe to the `AudioRoomsManager` events that we've added earlier and trigger the logic to handle participants joining or leaving the call.
