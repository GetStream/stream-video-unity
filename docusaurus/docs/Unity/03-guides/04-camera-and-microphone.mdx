...
Before you can set audio and video input sources you need to set up an instance of `StreamVideoClient`. Follow the [Client & Auth](../03-guides/client-auth.mdx) guide to learn how to do it.
